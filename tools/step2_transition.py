...
new_khan_block = """    // KHAN participates in every throw. Before its assigned winning throw it
    // is deterministically kept INSIDE the white circle, so it can visibly
    // shift after an impact without ever producing an early KHAN result.
    // On its assigned throw it becomes the targeted OUT object.
...
# Keep BUILD.txt at 0.2.1 for the historical runner's validation step.
# It is updated to 0.3.0 immediately after this one-time job succeeds.
